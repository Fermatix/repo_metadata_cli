...
*.bundle files), partner repos follow the pattern:
    ...
    https://gitlab.com/mirror-org/partner-private-repos/<partner>/<repo>.git
...
def parse_repo_org(url: str) -> Optional[str]:
    ...
    Examples:
        git.example.com/examplegrp/sample-suite/devops/logging.git
            -> "examplegrp/sample-suite/devops"
        gitlab.com/mirror-org/partner-private-repos/partnerorg/demorepo
            -> "mirror-org/partner-private-repos/partnerorg"
...
def build_org_map(repos_file: Path) -> Dict[str, str]:
    ...
    ".../alpha-fin/backend" and ".../beta-fin/backend") the stem
